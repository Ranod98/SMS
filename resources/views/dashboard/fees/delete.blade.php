    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 style="font-family: 'Cairo', sans-serif;" class="modal-title" id="exampleModalLabel">{{trans('fees.deleted_fee')}}</h5>
            ...
            <div class="modal-body">
                <form action="{{route('fees.destroy',$fee->id)}}" method="post">
                    ...
                    <h5 style="font-family: 'Cairo', sans-serif;">@lang('fees.confirm_delete')</h5>
