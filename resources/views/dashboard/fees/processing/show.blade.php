...
@section('page-header')
    ...
    <div class="page-title">
        <div class="row">
            <div class="col-sm-6">
                <h4 class="mb-0">@lang('fees.processing_fee_add') {{$student->name}}</h4>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                    ...
                    <li class="breadcrumb-item active">@lang('fees.processing_fee_add')</li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <form method="post"  action="{{ route('processingFees.store') }}" autocomplete="off">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input  class="form-control" name="debit" type="number" value="{{ $student->studentAccount->sum('debit') - $student->studentAccount->sum('credit') }}"  >
                        ...
                        <button class="btn btn-success btn-sm nextBtn btn-lg pull-right" type="submit">{{trans('fees.submit')}}</button>
                    </form>
