    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 style="font-family: 'Cairo', sans-serif;" class="modal-title" id="exampleModalLabel">{{trans('students.delete_student')}}</h5>
            ...
            <div class="modal-body">
                <form action="{{route('graduated.destroy',$student->id)}}" method="post">
                    ...
                    <h5 style="font-family: 'Cairo', sans-serif;">@lang('students.delete_student')</h5>
                    ...
                    <div class="modal-footer">
                        ...
                        <button  class="btn btn-danger">@lang('students.submit')</button>
                    </div>
                </form>
            </div>
        </div>
