                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade active show" id="home-02" role="tabpanel"
                                    ...
                                    <table class="table table-striped table-hover" style="text-align:center">
                                        <tbody>
                                        <tr>
                                            <th scope="row">{{trans('students.student_name')}}</th>
                                            <td>{{ $student->name }}</td>
                                        ...
                                        <tr>
                                            ...
                                            <th scope="row">{{trans('students.birth_date')}}</th>
                                            <td>{{ $student->birth_date}}</td>
                                        </tr>

                                        <tr>
                                            <th scope="row">{{trans('students.parent')}}</th>
                                            <td>{{ $student->studentParent->father_name}}</td>
                                ...
                                <div class="tab-pane fade" id="profile-02" role="tabpanel"
                                    ...
                                    <div class="card card-statistics">
                                        <div class="card-body">
                                            <form method="post" action="{{route('uploadAttachments',$student->id)}}" enctype="multipart/form-data">
                                                @csrf
                                                <div class="col-md-3">
